...
public partial class MSB_NR
{
    ...
    public class EventParam : Param<Event>
    {
        ...
        internal EventParam(BexReader br, bool lastParam) : base(br, lastParam, (br, version) => new(br, version)) { }
    ...
    public class Event : Entry
    {
        ...
        internal Event(BexReader br, int version)
        {
            ...
            if (typeOffset != 0)
            {
                ...
                TypeData = Type switch
                {
                    ...
                    EventType.TeamFight => new EventTeamFightData(br, version),
    ...
    public class EventCommon
    {
        ...
        internal EventCommon(BexReader br)
        {
            br.AssertInt32(-1);
    ...
    public class EventStruct28
    {
        ...
        internal EventStruct28(BexReader br)
        {
            Unk00 = br.ReadInt32();
            Unk04 = br.ReadInt32();
            br.AssertInt32(0);
    ...
    public class EventTreasureData : EventTypeData
    {
        ...
        internal EventTreasureData(BexReader br)
        {
            br.AssertInt32(0);
            br.AssertInt32(0);
    ...
    public class EventGeneratorData : EventTypeData
    {
        ...
        internal EventGeneratorData(BexReader br)
        {
            MaxNum = br.ReadByte();
            GenType = br.ReadByte();
    ...
    public class EventObjActData : EventTypeData
    {
        ...
        internal EventObjActData(BexReader br)
        {
            EntityId = br.ReadUInt32();
            _partIndex = br.ReadInt32();
    ...
    public class EventPlatoonInfoData : EventTypeData
    {
        ...
        internal EventPlatoonInfoData(BexReader br)
        {
            Unk00 = br.ReadInt32();
    ...
    public class EventPatrolRouteData : EventTypeData
    {
        ...
        internal EventPatrolRouteData(BexReader br)
        {
            Unk00 = br.ReadByte();
            br.AssertByte(0);
            br.AssertByte(0);
    ...
    public class EventRidingData : EventTypeData
    {
        ...
        internal EventRidingData(BexReader br)
        {
    ...
    public class EventBirdRouteData : EventTypeData
    {
        ...
        internal EventBirdRouteData(BexReader br)
        {
            br.AssertInt32(0);
            Unk04 = br.ReadInt32();
            Unk08 = br.ReadInt32();
    ...
    public class EventTalkInfoData : EventTypeData
    {
        ...
        internal EventTalkInfoData(BexReader br)
        {
            Unk00 = br.ReadInt32();
            Unk04 = br.ReadInt32();
            Unk08 = br.ReadInt32();
    ...
    public class EventTeamFightData : EventTypeData
    {
        ...
        internal EventTeamFightData(BexReader br, int version)
        {
            Unk00 = br.ReadInt32();
            Unk04 = br.ReadInt32();
            Unk08 = br.ReadInt32();
